...
import environmentMapPxImage from './environment/px.jpg'
import environmentMapPyImage from './environment/py.jpg'
import environmentMapPzImage from './environment/pz.jpg'
...
const fragmentShader = /* glsl */ `
    ...
    void main() {
        ...
        // Final color
        lighting = ambient + (hemi * 0.2) + (diffuse * 0.8);
    ...
    return (
        <mesh>
            <shaderMaterial
                ...
                uniforms={{ uSpecMap: { value: cubeTexture } }}
            />
