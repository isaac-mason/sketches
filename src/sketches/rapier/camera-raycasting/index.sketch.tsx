...
const Scene = () => {
    ...
    useFrame(() => {
        ...
        rayDirection.set(mouse.x, mouse.y, 0).unproject(camera).sub(camera.position).normalize()
        ...
        <>
            ...
            >
                <mesh>
                    ...
                    <meshStandardMaterial color={raycastHit === Shapes.CUBE ? 'red' : '#666'} />
                </mesh>
            </RigidBody>
            ...
            >
                <mesh>
                    ...
                    <meshStandardMaterial color={raycastHit === Shapes.TORUS ? 'red' : '#666'} />
                </mesh>
            </RigidBody>
            ...
            >
                <mesh>
                    ...
                    <meshStandardMaterial color={raycastHit === Shapes.CYLINDER ? 'red' : '#666'} />
                </mesh>
            </RigidBody>
            ...
            >
                <mesh>
                    ...
                    <meshStandardMaterial color={raycastHit === Shapes.ICOSAHEDRON ? 'red' : '#666'} />
                </mesh>
            </RigidBody>
            ...
            >
                <mesh>
                    ...
                    <meshStandardMaterial color={raycastHit === Shapes.TORUS_KNOT ? 'red' : '#666'} />
                </mesh>
            </RigidBody>
            ...
            >
                <mesh>
                    ...
                    <meshStandardMaterial color={raycastHit === Shapes.CONE ? 'red' : '#666'} />
                </mesh>
            </RigidBody>
            ...
            >
                <mesh>
                    ...
                    <meshStandardMaterial color={raycastHit === Shapes.SPHERE ? 'red' : '#666'} />
                </mesh>
            </RigidBody>
        </>
    )
