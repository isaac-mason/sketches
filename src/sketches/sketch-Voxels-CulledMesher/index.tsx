...
import { BufferAttribute, BufferGeometry, Color, Mesh, MeshStandardMaterial, PointLight, ShaderMaterial, Vector3 } from 'three'
...
class VoxelChunkMesh {
    ...
    constructor(private world: VoxelWorld, private chunk: VoxelChunk) {
