...
const GameWorld = () => {
    ...
    const onPointerDown = useCallback(
        (e: ThreeEvent<PointerEvent>) => {
            ...
            const hit = raycast(voxels.world, e.ray.origin, e.ray.direction, 100, _raycastHitPosition, _raycastHitNormal)
    ...
    useEffect(() => {
        ...
        const result = computePath(voxels.world, start, end, true, 'greedy', undefined, true)
