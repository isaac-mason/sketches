...
const GameWorld = () => {
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            chunkRigidBodies.forEach((chunkRigidBody) => {
    ...
    useFrame(() => {
        ...
        for (const chunkId of updatedChunks) {
            ...
            const chunkRigidBody = world.createRigidBody(Rapier.RigidBodyDesc.fixed())
...
const BoxCannonTool = () => {
    ...
    useEffect(() => {
        const onPointerDown = (event: MouseEvent) => {
            ...
            _mouse.set((event.clientX / gl.domElement.clientWidth) * 2 - 1, -(event.clientY / gl.domElement.clientHeight) * 2 + 1)
            ...
            if (intersects.length > 0) {
                ...
                const linvel = intersection.point.sub(camera.position).normalize().multiplyScalar(50).toArray()
