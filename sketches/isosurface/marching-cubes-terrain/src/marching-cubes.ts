 ...
 *
 * Adapted from: https://github.com/mikolalysenko/mikolalysenko.github.com/blob/master/Isosurface/js/marchingcubes.js
 *
 * Also see: http://local.wasp.uwa.edu.au/~pbourke/geometry/polygonise/
 */
...
const dims = [Voxels.CHUNK_SIZE, Voxels.CHUNK_SIZE, Voxels.CHUNK_SIZE]
